...
ITK generates two types of reports:

1. **Single Case Report** - Individual test run with trace viewer
2. **Suite Report** - Hierarchical xUnit-style report for multiple test cases

---

## Suite Report (Hierarchical View)

When running `itk suite --cases-dir <dir> --out <dir>`, generates a modern xUnit-style report:

```
<out-dir>/
├── index.html          ← Hierarchical suite report
...
│  Suite ID: suite-20260115-143200 · Mode: dev-fixtures · Duration: 2m 34s   │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  ┌──────┐  ┌──────┐  ┌──────┐  ┌──────┐  ┌──────┐  ┌──────┐                │
│  │  45  │  │  42  │  │   3  │  │   0  │  │ 93%  │  │ 150  │                │
...
When you click a test row, it expands to show:
